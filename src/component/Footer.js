      ...
      <div className='f-bot'>
        <div className='center'>
            <div className='left'>
                <div className='l-top'>
                    ...
                    <div className='info-copy'>
                        <div className='info'>
                            <div className='wrap'>
                                <p>서울특별시 송파구 올림픽로 240 호텔롯데 롯데월드</p>
                                <p>대표자:최홍훈</p>
                            </div>
                            <div className='wrap'>
                ...
                <div className='l-bot'>
                    <div className='f-wrap'>
                        <div className='f-icon'><img src='/img/f-icon1.png' /></div>
                        <div>
                    ...
                    <div className='f-wrap'>
                        <div className='f-icon'><img src='/img/f-icon2.png' /></div>
                        <p>한국서비스대상 명예의전당</p>
                    </div>
                </div>
            </div>
            <div className='right'>
                <div className='r-top'>
                    <ul className='f-sns'>
                        <li><a href='#'><img src='/img/f-sns1.png' alt='페이스북 이미지' /></a></li>
                        <li><a href='#'><img src='/img/f-sns2.png' alt='인스타그램 이미지' /></a></li>
                        <li><a href='#'><img src='/img/f-sns3.png' alt='유튜브 이미지' /></a></li>
                    </ul>
                    <select>
